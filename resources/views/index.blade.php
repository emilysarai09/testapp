  ...
  <body>
    ...
    <main role="main">
      ...
      <section class="jumbotron text-center">
        <div class="container">
          <h1 class="jumbotron-heading">Seguridad de Sistemas</h1>
          <p class="lead text-muted">Consejos y Tips para que mantengas tus equipos seguros</p>
        </div>
      </section>
    ...
    <footer class="text-muted">
      <div class="container">
        ...
        <p>Madrid - Alvarenga - Flores - Cabllero - Bernal</p>
      </div>
    </footer>
